...
class PreferenceParser {
    ...
    private static final String NS_SEARCH = "http://schemas.android.com/apk/allen.town.podcast.searchpreference";
    private static final List<String> BLACKLIST = Arrays.asList(SearchPreference.class.getName(), "PreferenceCategory","allen.town.podcast.common.common.prefs.supportv7.ATEPreferenceCategory");
    private static final List<String> CONTAINERS = Arrays.asList("PreferenceCategory", "PreferenceScreen","allen.town.podcast.common.common.prefs.supportv7.ATEPreferenceCategory");
