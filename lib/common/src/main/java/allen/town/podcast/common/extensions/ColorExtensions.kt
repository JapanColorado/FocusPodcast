...
import allen.town.podcast.theme.util.*
...
fun Context.defaultFooterColor() = resolveColor(allen.town.podcast.theme.R.attr.defaultFooterColor)

fun Fragment.defaultFooterColor() = resolveColor(allen.town.podcast.theme.R.attr.defaultFooterColor)
...
fun AppCompatImageButton.applyAccentColor() {
    val colorState = android.content.res.ColorStateList.valueOf(allen.town.podcast.theme.ThemeStore.accentColor(context))
    imageTintList = colorState
}
