 ...
 *
 */
package allen.town.podcast.theme.shortcut
...
object AppShortcutIconGenerator {
    ...
    private fun generateDefaultThemedIcon(context: Context, iconId: Int): Icon {
        ...
        return generateThemedIcon(
            context,
            iconId,
            context.getColor(allen.town.podcast.theme.R.color.app_shortcut_default_foreground),
            context.getColor(allen.town.podcast.theme.R.color.app_shortcut_default_background)
        )
    }
